...
import 'package:mangochatapp/features/screens/home_screen/widgets/last_message.dart';
import 'package:mangochatapp/features/screens/home_screen/widgets/un_read_count_widget.dart';
                  ...
                  itemBuilder: (context, index, animi) {
                    ...
                    if (userModel.id != FirebaseProvider.userId) {
                      return MyChatTile(
                        ...
                        onTap: () {
                          Navigator.pushNamed(context, AppRoutes.chatScreen,arguments: ChatScreenArguments(toId: toId, userModel: userModel));
                        },
