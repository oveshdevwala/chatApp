...
import 'package:mangochatapp/app/const/my_segment_bar.dart';
import 'package:mangochatapp/app/theme/colors_styles.dart';
import 'package:mangochatapp/features/chats/screen/home_screen/widgets/stream_state_widgets/error_state_chat_list.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            MySegmentBar(
              ...
              CurrentTab: 'Personal',
              onChanged: (value) {
                print('Your Segement Selected is $value');
              },
            ),
